...
import static time_experiment.FlatFit.FlatFit;
import static time_experiment.LBiX.LBiX;
import static time_experiment.MCQA.MCQA;
import static time_experiment.proposed.Proposed;
...
//        experiment with  varying numbers of query
        ...
        String filename = "DEBS2012-ChallengeData.txt";
...
//        experiment with  varying numbers of query
//        for(int i=0;i<5;i++) main_test(1);
//        for(int i=0;i<5;i++) main_test(2);
